          ...
          <div className='j6'>
            <div className='j7'>
              <Link href='/' className='d9'>
                <div style={{color:'white'}}>complaint</div>
              </Link>  
              <div>
               </div>
            </div>
            ...
            <div  style={{display:'flex', gap:'40px', marginLeft:'-280px'}}> 
              <div style={{display:'flex', gap:'100px'}}>  
                {session && (
                  <div onClick={sho} className='w2' style={{color:'white', display:'flex', height:'23px', textAlign:'center', width:'250px'}}>
                    ...
                    <div className='w6' style={{marginLeft:'15px'}}>
              ...
              <div>
                {!session && <Link href="/login/" className='w5'><div className='w2'  >LOGIN</div></Link>}
                {session && (<div onClick={() => signOut()} className='w5'  >LOGOUT</div>)}
              </div>
              </div>
            </div>
          </div> 
